                ...
                const context = (function () {
                    ...
                    extendFrame = function (ancestorIdx) {
                        let newFrame = {
                            ...
                            typeRegisterRef: typeRegister.extend(
                                frameStore[ancestorIdx].typeRegisterRef
                            ),
                        };
                ...
                const typeSignatures = (function () {
                    ...
                    return {
                        ...
                        compare: function (tsLeft, tsRight) {
                            ...
                            if (
                                typeof tsLeft.description === "function" &&
                                typeof tsRight.description === "function"
                            ) {
                                let X = Symbol();
                            ...
                            if (
                                Array.isArray(tsLeft.description) &&
                                Array.isArray(tsRight.description)
                            ) {
                                if (equal(tsLeft, tsRight)) {
                                    return typeSignatures.relation.same;
                                }
                                if (
                                    typeSignatures.compare(tsLeft.left, tsRight.left) ===
                                    typeSignatures.relation.same
                                ) {
                                    return typeSignatures.compare(
                                        tsLeft.right,
