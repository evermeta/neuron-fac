...
})()(
    {
        ...
        3: [
            ...
            },
            {
                "./chai/assertion": 4,
                "./chai/config": 5,
                "./chai/core/assertions": 6,
                "./chai/interface/assert": 7,
                "./chai/interface/expect": 8,
                "./chai/interface/should": 9,
                "./chai/utils": 23,
                "assertion-error": 1,
            },
        ],
        ...
        15: [
            ...
            { "./flag": 16, "assertion-error": 1, "type-detect": 39 },
        ],
        16: [
            function (require, module, exports) {
                /*!
        ...
        19: [
            ...
            { "./flag": 16, "./getActual": 17, "./objDisplay": 27 },
        ],
        20: [
            function (require, module, exports) {
                /*!
                ...
                (function (Math) {
                    ...
                    tinycolor.prototype = {
                        ...
                        toName: function () {
                            ...
                            return (
                                hexNames[rgbToHex(this._r, this._g, this._b, true)] ||
                                false
                            );
                        },
...
let prog = _T(`true[INT] 4 5`);*/
                ...
                AJS.toInit(function ($) {
                    ...
                    ACTION.addElement({
                        name: "writeA",
                        value: () => AJS.$("#result").val("A"),
                    });
                    ACTION.addElement({
                        name: "writeB",
                        value: () => AJS.$("#result").val("B"),
                    });

                    let prog1 = new connectors.Connector({
                        left: BOOL.gtAB,
                        right: ACTION,
                    });
                    let prog2 = new connectors.Connector({
                        left: prog1,
                        right: ACTION.writeA,
                    });
                    let prog3 = new connectors.Connector({
                        left: prog2,
                        right: ACTION.writeB,
                    });
        ...
        42: [
                ...
                const typeRegister = (function () {
                    let names = [],
                        ...
                        findComposedType = function (signature) {
                            let idx = composedTypes.findIndex((x) =>
                                eql(signature, x.signature)
                            );
                            if (idx === -1) {
                                return undefined;
                            }
                    ...
                    return {
                        ...
                        includes: function ({ alias, signature }) {
                            ...
                            if (typeID) {
                                assert(
                                    eql(signature, names[typeID].signature),
                                    "found a type with similar name but different signature"
                                );
                                return typeID;
                            }
                            if (eql(signature, [])) {
                                //this is an atomic type, check if the name is defined
                                return atomicTypes.find((atomicType) =>
                                    eql(alias, atomicType.alias)
                                );
                            }
            ...
            { chai: 2, "deep-eql": 35, tinycolor2: 38 },
        ],
        43: [
            function (require, module, exports) {
                /*******************************************
