(function () {
...
})()(
    {
        ...
        15: [
            ...
            { "./flag": 16, "assertion-error": 1, "type-detect": 41 },
        ],
        16: [
            function (require, module, exports) {
                /*!
...
*/
        ...
        36: [
            ...
            { "./lib/is_arguments.js": 37, "./lib/keys.js": 38 },
        ],
        37: [
            function (require, module, exports) {
        ...
        42: [
            function (require, module, exports) {
                ...
                const typeSignatures = (function () {
                    ...
                    isSameSignature = (sLeft, sRight) =>
                        typeSignatures.compare(sLeft, sRight) ===
                        typeSignatures.relation.same;

                    return {
                        errors: {
                            unknownTypeDescription:
                                "Unable to construct signature from description",
                        },
                ...
                return typeSignatures.compare(
                    ...
                    signature(tsRight.description(X)))
                            ...
                            if (tsLeft.category === typeSignatures.categories.Atomic) {
                                if (
                                    tsRight.category !== typeSignatures.categories.Atomic
                                ) {
                            ...
                            if (tsLeft.category === typeSignatures.categories.Arrow) {
                                if (
                                    tsRight.category === typeSignatures.categories.Arrow
                                ) {
                                    if (
                                        typeSignatures.compare(
                                            tsLeft.left,
                                            tsRight.left
                                        ) === typeSignatures.relations.same
                                    ) {
                                        return typeSignatures.compare(
                                            tsLeft.right,
                                            tsRight.right
                ...
                if(typeSignatures.compare(tsLeft.left, tsRight.left) === typeSignatures.relation.same){
                    return typeSignatures.compare(tsLeft.right, tsRight.right)
                        ...
                        deduce: function ({ leftSignature, rightSignature }) {
                            ...
                            if (
                                leftSignature.category ===
                                    typeSignatures.categories.Arrow &&
            ...
            { chai: 2, "deep-equal": 36 },
        ],
        43: [
            function (require, module, exports) {
                const typeSignatures =
                    require("../../src/types/typeSignatures.js").typeSignatures;

                let ts1 = typeSignatures.signature({ typeDescription: ["A"] });
            },
            { "../../src/types/typeSignatures.js": 42 },
        ],
    },
    {},
    [43]
