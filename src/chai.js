                    ...
                    module.exports = function (chai, _) {
                        ...
                        Assertion.addMethod("members", function (subset, msg) {
                            ...
                            if (contains) {
                                ...
                                failMsg =
                                    "expected #{this} to be " + subject + " of #{exp}";
                                failNegateMsg =
                        ...
                        function assertDelta(delta, msg) {
                            ...
                            if (behavior === "change") {
                                expression =
                                    Math.abs(final - initial) === Math.abs(delta);
                            } else {
                        ...
                        Assertion.addProperty("sealed", function () {
                            ...
                            var isSealed =
                                obj === Object(obj) ? Object.isSealed(obj) : true;
                        ...
                        Assertion.addProperty("frozen", function () {
                            ...
                            var isFrozen =
                                obj === Object(obj) ? Object.isFrozen(obj) : true;
                ...
                function (require, module, exports) {
                    ...
                    module.exports = function (chai, util) {
                        ...
                        assert.notInclude = function (exp, inc, msg) {
                            new Assertion(exp, msg, assert.notInclude, true).not.include(
                                inc
                            );
                        };
                        ...
                        assert.ownInclude = function (exp, inc, msg) {
                            new Assertion(exp, msg, assert.ownInclude, true).own.include(
                                inc
                            );
                        };
                        ...
                        assert.changes = function (fn, obj, prop, msg) {
                            ...
                            new Assertion(fn, msg, assert.changes, true).to.change(
                                obj,
                                prop
                            );
                        };
                        ...
                        assert.isNotExtensible = function (obj, msg) {
                            new Assertion(obj, msg, assert.isNotExtensible, true).to.not
                                .be.extensible;
                        };
                        ...
                        assert.isNotEmpty = function (val, msg) {
                            new Assertion(val, msg, assert.isNotEmpty, true).to.not.be
                                .empty;
                        };
                    ...
                    module.exports = function overwriteChainableMethod(
                        ...
                        chainableBehavior.chainingBehavior =
                            function overwritingChainableMethodGetter() {
                                var result =
                                    chainingBehavior(_chainingBehavior).call(this);
                                if (result !== undefined) {
                                    return result;
                                }
                ...
                function (require, module, exports) {
                    ...
                    function internalSetPathValue(obj, val, parsed) {
                        ...
                        for (var i = 0; i < pathDepth; i++) {
                            ...
                            if (i === pathDepth - 1) {
                                propName =
                                    typeof part.p === "undefined" ? part.i : part.p;
